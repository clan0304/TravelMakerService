    ...
    <div className="relative w-full aspect-[16/9]">
      <div className="absolute inset-0 z-10 flex items-center justify-center">
        <div className="relative w-full h-full text-center">
          ...
          <p className="absolute top-[58%] xs:top-[58%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-[10px] xs:text-[4vw] font-lato whitespace-nowrap tracking-wide">
            In a Great Place
          </p>
